...
<html>
	...
	<body>
		<main class="container">
			<header id="top">
				<h1 class="green">D-D-downvote!</h1>
				<h2 class="greenbox">So, you've decided that isn't a great idea?</h2>
				<p>
					Since this is your first time voting, you must first accept our <a href="privacy.html">Privacy Policy</a>
					before you can downvote anything. In short, you must be aware that:
				</p>
			</header>
