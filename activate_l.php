...
<html>
	...
	<body>
		<main class="container">
			<header id="top">
				<h1 class="green"><span class="glyphicon glyphicon-heart"></span></h1>
				<h2 class="greenbox">We respect those who support what they believe in</h2>
				<p>
					Since this is your first time voting, you must first accept our <a href="privacy.html">Privacy Policy</a>
					before you can upvote anything. In short, you must be aware that:
				</p>
			</header>
